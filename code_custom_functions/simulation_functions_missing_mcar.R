...
# 1) Sim.AR.Model.mcar = Data generation function. Creates a single dataset, introduces data missing at random
...
Power.Estimates.Sim.r.mcar = function(data,N,T.obs,Ylag.center,
