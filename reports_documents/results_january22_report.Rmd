...
# Results: Simulation B

## Simulation design

In simulation B, only fixed slopes and random and fixed intercepts were simulated and analysed.

Simulation B followed a 4 × 2 × 2 × 4 × 2 × 2 factorial design (yielding 256 simulation conditions in total):
