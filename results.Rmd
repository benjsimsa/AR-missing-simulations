...
The standard errors in the estimation of fixed AR effect are considerably smaller when person-mean centering is not used (Table \ref{tab:tab_se_supp}) compared to Simulation A (Table 5). Figure \ref{fig:fig_compl_tobs_se_supp} illustrates the interaction between compliance and the number of timepoints.
