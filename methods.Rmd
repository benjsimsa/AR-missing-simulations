...
**Bayesian estimation.** Bayesian MCMC represents a flexible way to estimate the MLAR(1) model [@krone2016]. In the context of missing observations, it allows to avoid list-wise deletion of observation-pairs when either the outcome or the predictor are missing by using the estimated autoregressive parameter to estimate the value of the missing observations [@krone2016].
